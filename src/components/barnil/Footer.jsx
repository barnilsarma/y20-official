...
function Footer() {
    return (
      <footer>
        <div className='part1'>
            <div className='left'><img src={y20} /><img src={g20} /></div>
            <div className='right'>
                <h1>FOLLOW US</h1>
                <div className='social-media-cont'><a><img src={Twitter} /></a><a><img src={Insta} /></a><a><img src={YouTube} /></a><a><img src={Fb} /></a></div>
                <h1>CONTACT US</h1>
                <p>
